##########################
# In class activity 9/25
# 1) download gold prices, TIPS, Break-even inflation, Trade-weighted dollar 
#     index and merge them for a common time window of 01-03-2006 to 06-30-2020
...
# 3) Use log differences for gold price for log returns, but simple differences
